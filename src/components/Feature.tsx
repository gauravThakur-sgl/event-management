...
export const Feature = () => {
  ...
  const logos = [ <RelumeLogo height={60} width={60} />, <Slack height={50} width={50} />, <NotionLogo height={70} width={70} />,<FacebookLogo  height={50} width={50} />, <InstagramLogo height={50} width={50} />];
