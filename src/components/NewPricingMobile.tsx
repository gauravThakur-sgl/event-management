    ...
    <div className="flex flex-col justify-center items-center max-w-[800px]">
        ...
        {eventManagementPricing.map((item, index) => (
          <div key={index}>
            {item.planName === "Popular" && (
              <div
                className={`text-center p-1 min-w-32 max-w-44 border rounded-t-xl text-sm ${
                  active === index
            ...
            <div
              ...
              className={`min-w-32 max-w-44 border ${
                active === index ? "shadow-xl transition-all duration-200" : "transition-all duration-200"
              } ${item.planName === "Popular" ? "rounded-b-2xl" : "rounded-2xl"} min-w-32 max-w-44`}
            >
      ...
      {eventManagementPricing.map((item, index) => (
        <div key={index}>
          {active === index && (
            <div>
              <div className="px-6 pt-5 pb-2 w-[800px] flex justify-between items-center">
