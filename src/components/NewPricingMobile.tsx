...
export const NewPricingMobile = ({ eventManagementPricing, active, handleActive }: IEventManagementPricing) => {
  return (
    <div className="flex flex-col justify-center items-center pt-10">
      <div className="flex justify-center items-end pricing-width">
        {eventManagementPricing.map((item, index) => (
          <div key={index}>
            ...
            >
              <div className="w-24 md:w-32 h-20 relative rounded-xl border p-2 bg-gradient-to-br from-green-700 via-green-500 to-green-700">
