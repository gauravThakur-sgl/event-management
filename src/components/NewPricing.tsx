        ...
        <div className="flex justify-center items-end gap-2 pt-5 ">
          {eventManagementPricing.map((item, index) => (
            <div
              ...
              className={`${active ? "shadow-xl transition-all duration-200" : "transition-all duration-200"}`}
            >
              {item.planName === "Popular" && (
                <div
                  className={`text-center p-1 min-w-56 max-w-64 border rounded-t-xl text-sm ${
                    active
              ...
              <div
                ...
                } max-w-64 p-2 scroll-height`}
              >
                <div className="rounded-xl border p-2 bg-gradient-to-br from-blue-800 via-blue-500 to-blue-800">
